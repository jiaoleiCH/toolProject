        ...
        if(this.checkIsWeChatGame()) {
            if(typeof(wx.navigateToMiniProgram) == 'function') {
                wx.navigateToMiniProgram({
                    appId: data.appid ? data.appid : T.moreGameData.appid,
                    path: data.path ? data.path : T.moreGameData.path,
                    envVersion: data.envVersion ? data.envVersion : T.moreGameData.envVersion,
                    extraData : data.extraData ? data.extraData : T.moreGameData.extraData,
                    success: ()=>{  
